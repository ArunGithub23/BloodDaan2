...
contract Bloodtoken{
    ...
    mapping(uint256 => BloodUnit) public BloodStore;
        ...
        )
    {
        ...
        BloodStatus memory tempStatus = BloodStore[_id]
    ...
    mapping(address => User) public UserStore;
